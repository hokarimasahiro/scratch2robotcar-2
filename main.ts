...
MbitMore.setSharedData(SharedDataIndex.DATA0, slot1Value)
if (carcotrol.getCarType() == carcotrol.car(carType.Tinybit)) {
    basic.showString("T")
} else if (carcotrol.getCarType() == carcotrol.car(carType.Maqueen)) {
    basic.showString("M")
} else if (carcotrol.getCarType() == carcotrol.car(carType.Roomba)) {
    basic.showString("R")
} else if (carcotrol.getCarType() == carcotrol.car(carType.Ecocar0)) {
    basic.showString("E")
} else {
    basic.showString("U")
}
